...
execute if score #stopper nugget.track > #stopper nugget.track3 if score #stopper nugget.track <= #stopper baltop.track run function blockmart:baltop

execute if score #stopper nugget.track <= #stopper nugget.track3 run scoreboard players add #baltop.counter nugget.track 1
execute if score #stopper nugget.track <= #stopper baltop.track as @a[tag=!baltopper] run function blockmart:try_baltop_false
