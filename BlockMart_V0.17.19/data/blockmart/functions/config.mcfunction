...
tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #enchants blockmart.config "},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to edit Enchants toggle.","color":"gray"},{"text":"\nAccepts: whole numbers 0+\nDefault: 0\n0=off - 1=on","color":"dark_gray"}]}}," Enchants ",{"text":"(Current: ","color":"gray"},{"score":{"name":"#enchants","objective":"blockmart.config"},"color":"gray"},{"text":")","color":"gray"}]
